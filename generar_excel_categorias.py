...
current = [
    ...
    ["Miura", "Cafeterías y panadería", "Instagram: cocina española", "No", "Podría ser Internacional"],
...
proposed = [
    ...
    ["Miura", "Cafeterías y panadería", "Internacional", "Cafeterías + Internacional", "Cocina española (según IG)"],
